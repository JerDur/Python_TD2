...
with open('/hometu/etudiants/b/l/E155781C/workspace/Semestre4/Git/Python_TD2/CSV/J334_equipements_activites.csv', 'r') as csvfile:
    ...
    for row in reader:
        ...
        query = ("SELECT * from equiêùents_activites 

with open('/hometu/etudiants/b/l/E155781C/workspace/Semestre4/Git/Python_TD2/CSV/23440003400026_J335_installations_table.csv', 'r') as csvfile:
    reader = csv.reader(csvfile, delimiter=',', quotechar='*')
    for row in reader:
        liste.append(row)
